...
import warningTrend from './WarningTrend.vue';
    ...
    data() {
        return {
            list: [
                {
                    id: 1,
                    imgUrl: require('https://unier.oss-cn-beijing.aliyuncs.com/industry/images/icon-warn.png'),
                    text: '预警总数',
                    value: 169
                },
                {
                    id: 2,
                    imgUrl: require('https://unier.oss-cn-beijing.aliyuncs.com/industry/images/icon-city.png'),
                    text: '接入企业数',
                    value: 3456
                },
                {
                    id: 3,
                    imgUrl: require('https://unier.oss-cn-beijing.aliyuncs.com/industry/images/icon-camera.png'),
                    text: '镜头总数',
                    value: 6921
                }
            ]
...
.main {
    ...
    grid-template-areas:
        "left-aside_1 left-aside_1 center_1 center_1 center_1 right-aside_1 right-aside_1"
        "left-aside_1 left-aside_1 center_2 center_2 center_2 right-aside_1 right-aside_1"
        "left-aside_2 left-aside_2 center_2 center_2 center_2 right-aside_2 right-aside_2"
        "left-aside_2 left-aside_2 center_2 center_2 center_2 right-aside_2 right-aside_2"
}
